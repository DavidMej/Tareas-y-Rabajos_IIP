...
Private Sub btnRegist_Click(sender As Object, e As EventArgs) Handles btnRegist.Click
    ...
    For i = 0 To (cantComputadoras - 1) Step 1
            ...
            mComputadoras(i, 0) = InputBox("Ingrese la marca la No." & (i + 1), "Registro")
            mComputadoras(i, 1) = InputBox("Ingrese el modelo la No." & (i + 1), "Registro")
            mComputadoras(i, 2) = InputBox("Ingrese el precio la No." & (i + 1), "Registro")
            mComputadoras(i, 3) = InputBox("Ingrese la cantidad la No." & (i + 1), "Registro")
            index = i
    Next
End Sub
...
Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
    ...
    If (encuentra = False) Then
        MessageBox.Show("No existe", "Error de venta", MessageBoxButtons.OK, MessageBoxIcon.Warning)
        txtMarca.Clear()
    End If
End Sub
...
Private Sub btnVender_Click(sender As Object, e As EventArgs) Handles btnVender.Click
    ...
    stock = mComputadoras(Index, 3)
        ...
        If cantVender > stock Then
            MessageBox.Show("El stock es insuficiente", "Error de venta", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            txtCantVender.Text = ""

        ElseIf cantVender = stock Then
            MessageBox.Show("Stock vacío", "Error de venta", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            txtCantidad.Text = "0"
